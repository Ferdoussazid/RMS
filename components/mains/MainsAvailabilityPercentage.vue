<template>
  <div class="flex grow flex-row items-center justify-end md:mr-4">
    ...
    <span class="ml-2 text-xs font-normal leading-tight text-gray-600"> Grid Availability in</span>
    <div class="w-[120px]">
...
export default {
  ...
  methods: {
    ...
    async onAvailabilityMonthChanged(date) {
      this.loading = true
      try {
        await this.$store.dispatch('mains/getAvailability', {
