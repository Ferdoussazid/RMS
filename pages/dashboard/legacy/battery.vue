...
export default {
    ...
    computed: {
        ...
        ...mapGetters('dashboard-legacy', ['battery', 'selectedTenant']),
        focusedEventName() {
    ...
    methods: {
        ...
        async fetchData() {
            this.$store.dispatch('dashboard-legacy/getBattery', { user_uid: this.rootUserUid })
        },
        ...
        generateDataValues(site) {
            return [
                {
                    value: site.soc ? site.soc : '-',
                    label: 'SOC',
                },
                {
                    value: site.soh ? site.soh : '-',
                    label: 'SOH',
                },
            ]
        },
